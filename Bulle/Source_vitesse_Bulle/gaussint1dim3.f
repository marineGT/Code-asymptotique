...
c****************************************************************
      ...
      function gaussint1dim3(solparticuliere,a,b,teta,Nt,c,
...
c$$$      end interface
      ...
      double precision :: teta, c, zetap, lambda0     
...
c      WRITE(*,*) 'debut gaussint2, c= ', c
 ...
 2    c1=hf*(bb+aa)
      ...
      do 3 i = 1,4
      u=c2*x(i)
      s8=s8+wter(i)*(solparticuliere(c1+u,teta,Nt,c,zetap,
     & lambda0,alpha,alpha0,Bn,Dn,cstSn)
     & +solparticuliere(c1-u,teta,Nt,c,zetap,lambda0,alpha,
     & alpha0,Bn,Dn,cstSn))
c      write (*,*) c2, teta, s8
 3    continue
      s16=0
      do 4 i = 5,12
      u=c2*x(i)
      s16=s16+wter(i)*(solparticuliere(c1+u,teta,Nt,c,zetap,
     & lambda0,alpha,alpha0,Bn,Dn,cstSn)
     & +solparticuliere(c1-u,teta,Nt,c,zetap,lambda0,alpha,
     & alpha0,Bn,Dn,cstSn))      
 4    continue
