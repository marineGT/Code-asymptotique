...
c****************************************************************
      ...
      function gaussint1dim4(constanteSn,a,b,Nt,c,zetap,
...
c      WRITE(*,*) 'debut gaussint2, c= ', c
 ...
 2    c1=hf*(bb+aa)
      ...
      do 3 i = 1,4
      u=c2*x(i)
      s8=s8+wter(i)*(constanteSn(c1+u,Nt,c,zetap,lambda0,
     & alpha,alpha0,Bn,Dn)+constanteSn(c1-u,Nt,c,zetap,
     & lambda0,alpha,alpha0,Bn,Dn))
 3    continue
      s16=0
      do 4 i = 5,12
      u=c2*x(i)
      s16=s16+wter(i)*(constanteSn(c1+u,Nt,c,zetap,lambda0,
     & alpha,alpha0,Bn,Dn)+constanteSn(c1-u,Nt,c,zetap,
     & lambda0,alpha,alpha0,Bn,Dn))
 4    continue
      s16=c2*s16
