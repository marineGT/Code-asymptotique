...
c2345678912345678912345678912345678912345678912345678912345678912
      ...
      function gaussint1dim6(testvolume,a,b,Nx,g,tabg,
     &                       b1,e1,d1,prec)
c     ===========================================================
...
c      WRITE(*,*) 'debut gaussint, c= ', c
 ...
 2    c1=hf*(bb+aa)
      ...
      do 3 i = 1,4
      u=c2*x(i)
      s8=s8+wter(i)*(testvolume(c1+u,Nx,g,tabg,b1,e1,d1)
     & +testvolume(c1-u,Nx,g,tabg,b1,e1,d1))
 3    continue
      s16=0
      do 4 i = 5,12
      u=c2*x(i)
      s16=s16+wter(i)*(testvolume(c1+u,Nx,g,tabg,b1,e1,d1)
     & +testvolume(c1-u,Nx,g,tabg,b1,e1,d1))
 4    continue
      s16=c2*s16
