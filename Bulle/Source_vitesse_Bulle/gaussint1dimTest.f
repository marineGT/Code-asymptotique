...
c****************************************************************
      ...
      function gaussint1dimtest(solpartitest,a,b,prec)
c     ============================================================  
...
c      WRITE(*,*) 'debut gaussint2, c= ', c
 ...
 2    c1=hf*(bb+aa)
      ...
      do 3 i = 1,4
      u=c2*x(i)
      s8=s8+wter(i)*(solpartitest(c1+u)+solpartitest(c1-u))
 3    continue
      s16=0
      do 4 i = 5,12
      u=c2*x(i)
      s16=s16+wter(i)*(solpartitest(c1+u)+solpartitest(c1-u))
 4    continue
      s16=c2*s16
