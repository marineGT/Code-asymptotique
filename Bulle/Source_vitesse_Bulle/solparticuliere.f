...
c2345678912345678912345678912345678912345678912345678912345678912
      ...
      function solparticuliere(b,teta,Nt,c,zetap,lambda0,alpha,
     &                        alpha0,Bn,Dn,cstSn)
c     ============================================================
...
c     &    -3.d0*dcos(b)*dsin(3.d0*b)! avec testf=cos(3*teta)-cos(teta)

      solparticuliere=(1.d0+dcos(teta)*dlog(dtan(teta/2.d0)))
     &               *dcos(b)-dcos(teta)*(1.d0+dcos(b)
     &               *dlog(dtan(b/2.d0)))

      solparticuliere=aux*dsin(b)*solparticuliere
c      write(*,*) 'solparticuliere=', solparticuliere
      !test avec f=cos(3*teta)

c      write(16,*) teta, xi, solparticuliere
